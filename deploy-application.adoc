...
describe bc/blog` with the Git repository on GitHub. After the webhook has
been registered, any push of new code up to the Git repository on GitHub
will automatically trigger a new build and deployment.
