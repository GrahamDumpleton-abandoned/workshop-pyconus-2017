...
image::web-console-empty-project.png[Web Console Empty Project]

If metrics has been enabled in the OpenShift environment being used for
...
image::web-console-enable-metrics.png[Web Console Enable Metrics]

Click on the the link that says *Open metrics URL*, and add an exception
for the certificate.

In the remainder of this workshop you will be using both the command line
and the web console. In the next exercise you will deploy your first web
application.
